...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.PositiveSmallIntegerField(default=1, help_text='Please indicate the quantity of ingredients.', validators=[django.core.validators.MinValueValidator(1, 'The number of ingredients must be >=1.'), django.core.validators.MaxValueValidator(9000, 'Too many ingredients')], verbose_name='Amount of ingredients')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cooking_time', models.IntegerField(default=1, help_text='Enter the cooking time for the recipe in minutes.', validators=[django.core.validators.MinValueValidator(1, 'Cooking time must be >=1 minute.'), django.core.validators.MaxValueValidator(9000, 'Cooking time exceeds all norms!')], verbose_name='Recipe preparation time in minutes.')),
