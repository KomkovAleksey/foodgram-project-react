...
`POST https://kittygram2023.ddns.net/api/users/` - Регистрация пользователя
```
Запрос:
{
  "username": "James",
  "password": "0767dsadB85656756"
}
...
`GET https://kittygram2023.ddns.net/api/cats/` - Cписок всех котов:
```
Ответ:

{
    ...
    "results": [
        ...
        },
        {
            ...
            "owner": 1,
            "age": 13,
            "image": "http://kittygram2023.ddns.net/media/cats/images/temp_pgWM2kk.jpeg"
        },
        {
            "id": 2,
            "name": "Василий",
            ...
            "achievements": [
                {
                    "id": 1,
                    "achievement_name": "Нассал в тапки"
                }
            ],
            "owner": 1,
            "age": 22,
            "image": "http://kittygram2023.ddns.net/media/cats/images/temp.webp"
        },
        {
            "id": 3,
            "name": "Пират",
            ...
            "owner": 1,
            "age": 13,
            "image": "http://kittygram2023.ddns.net/media/cats/images/temp_AJQT6xB.jpeg"
        },
        {
            "id": 5,
            "name": "Кардинал",
            ...
            "owner": 1,
            "age": 4,
            "image": "http://kittygram2023.ddns.net/media/cats/images/temp_E5GyUdn.jpeg"
        }
    ]
}
```
`GET https://kittygram2023.ddns.net/api/users/` - Cписок всех пользователей:
```
Ответ
{
    "count": 1,
