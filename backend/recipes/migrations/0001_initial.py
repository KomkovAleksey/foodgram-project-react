...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.PositiveSmallIntegerField(default=1, help_text='Please indicate the quantity of ingredients.', validators=[django.core.validators.MinValueValidator(1, {'ingredient': 'The number of ingredients must be >=1.'}), django.core.validators.MaxValueValidator(9000, {'ingredient': 'The quantity of ingredients has reached the limit!'})], verbose_name='Amount of ingredients')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, upload_to='recipes/images/', verbose_name='Recipe image')),
